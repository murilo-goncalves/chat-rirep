...
class Chat_GUI: 
	...
	def __init__(self): 
		...
		self.pls = Label(self.login, 
				         bg="#FFEDAD",
					     text = "Bem vindo ao chat da Ri Rep!\n Qual teu nome, raio de Sol?", 
					     justify = CENTER, 
					     font = "Helvetica 14 bold") 
	
		self.pls.place(anchor="center", x=200, y=25)
...
# create a Chat_GUI class object 
g = Chat_GUI() 
